...
{
    public class StructureMapServiceLocator : IServiceLocatorCreateScope, IServiceLocator, IServiceLocatorWireupCollection
    {
        private readonly IContainer _container;
        private bool _isWiredUp;

        public StructureMapServiceLocator(IContainer rootContainer) => _container = rootContainer as Container;

        public IServiceLocatorScoped CreateScope() => 
            new StructureMapServiceLocatorScoped(_container.OpenScope(), null);
