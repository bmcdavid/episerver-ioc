...
{
    public class StructureMapServiceLocatorScoped : BaseScopedServiceLocator, IServiceLocatorScoped
    {
        private readonly IResolverContext _resolverContext;

        public StructureMapServiceLocatorScoped(IResolverContext resolverContext, IServiceLocatorScoped parentScope)
        {
        ...
        public IServiceLocatorScoped CreateScope() => RegisterAndReturnScope(new StructureMapServiceLocatorScoped(_resolverContext.OpenScope(), this));
