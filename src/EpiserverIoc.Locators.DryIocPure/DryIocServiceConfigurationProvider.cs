...
using EPiServer.ServiceLocation.Internal; // todo: internal usage
using System;

namespace EpiserverIoc.Locators.DryIocPure
{
    public class DryIocServiceConfigurationProvider : IServiceConfigurationProviderWithEnvironment, IRegisteredService, IInterceptorRegister
    {
